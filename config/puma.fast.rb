...
control_address = Postal.config.fast_server&.control_address || '127.0.0.1'
control_port    = Postal.config.fast_server&.control_port&.to_i || '9294'
control_token   = Postal.config.fast_server&.control_token || 'foo'
